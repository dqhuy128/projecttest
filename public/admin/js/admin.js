 shop.admin = {
    ...
    copy:function(id, type){
     ...
     updateStatusPromoteCampaign:function(id, show, type){
    ...
    system:{
        ckEditor: function (ele,width,height,theme,toolbar, css,id_img_btn) {
            ...
            CKEDITOR.config.fontSize_sizes =  '11px;12px;13px;14px;15px;16px;17px;18px;19px;20px;21px';
            CKEDITOR.config.pasteFromWordRemoveFontStyles = true;
            CKEDITOR.config.allowedContent=true;
            CKEDITOR.config.font_names = 'SFProText;'+
            ...
            CKEDITOR.config.line_height="1px;2px;5px;10px;15px;20px;25px;30px;35px";
