var app = new Vue({
    ...
    // },
    methods:{
        changeAltImage: function (id) {
            var vm = this;
            let data = {
              id: id,
              alt: vm.curImage.alt_img,
              is_reality: vm.curImage.is_reality ? 1 : 0,
            };
            shop.ajax_popup('product/change-img', 'POST', data,
                function(json) {
                    app.loading = false;
                    let msg = json.msg;
                    if(json.error == 0){
