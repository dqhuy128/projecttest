            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="type">Danh mục gôc</label> <br>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <select id="id_sell" name="id_sell" class="form-control{{ $errors->has('id_sell') ? ' is-invalid' : '' }} select2 w-100"">
                                                @include('BackEnd::pages.tag.option_multi', [
                                                    'options' => $cat,
                                                    'def' => [old_blade('id_sell')],
                                                    'mode' => 1
                                                ])
                                            </select>
                                        </div>
                    ...
                    <div class="row d-none" id="pslide" >
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="w-100">
                                    <select id="pid" name="pid[]" class="form-control{{ $errors->has('pid') ? ' is-invalid' : '' }} select2 w-100" multiple="multiple">
                                        @include('BackEnd::pages.tag.option_multi', [
                                            'options' => $cat,
                                            'def' => @$tagsCate??[],
                                            'mode' => 1
...
@stop
@section('css')
    {!! \Lib::addMedia('admin/js/library/select2/select2.min.css') !!}
@stop
@section('js_bot')
    {!! \Lib::addMedia('admin/js/library/select2/select2.min.js') !!}
    <script>
