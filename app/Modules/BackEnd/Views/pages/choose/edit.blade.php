                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="image" name="image" class="dropify form-control {{ $errors->has('image') ? ' is-invalid' : '' }}" data-default-file="{{ @\ImageURL::getImageUrl(old('image', @$data['image']), 'choose', 'original') }}">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" id="content" name="content" rows="10" required>{{ old_blade('content') }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
