                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label for="title">Tên khách hàng <span class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" value="{{ old_blade('name') }}" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="title">Địa chỉ <span class="text-danger">*</span></label>
                                                                    <input type="text" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}" id="address" name="address" value="{{ old_blade('address') }}" required>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="file" id="avartar" name="avartar" class="dropify form-control {{ $errors->has('avartar') ? ' is-invalid' : '' }}" data-default-file="{{ @\ImageURL::getImageUrl(old('avartar', @$data['avartar']), 'customer', 'original') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                        <div class="form-group">
                                                                            <label for="image">Ảnh đại diện <span class="text-danger">*</span></label>
                                                                            <input type="file" id="image" name="image" class="dropify form-control {{ $errors->has('image') ? ' is-invalid' : '' }}" data-default-file="{{ @\ImageURL::getImageUrl(old('image', @$data['image']), 'customer', 'original') }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control{{ $errors->has('feedback') ? ' is-invalid' : '' }}" id="feedback" name="feedback" required>{!!  old_blade('feedback')  !!}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
