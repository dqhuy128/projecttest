                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach($roles as $r)
                                            <div class="checkbox checkbox-success">
                                                <input type="checkbox" id="checkbox{{ $r->id }}" name="roles[]" value="{{ $r->id }}"{{ in_array($r->id, $user_roles)?' checked':'' }}{{ !\Auth::user()->checkMyRank($r->rank)?' disabled':'' }}>&nbsp;
                                                <label for="checkbox{{ $r->id }}">{{ $r->title }}</label>
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
