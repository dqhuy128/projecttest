                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="image" name="image" class="dropify form-control {{ $errors->has('image') ? ' is-invalid' : '' }}" data-default-file="{{ @\ImageURL::getImageUrl(old('image', @$data['image']), 'intro', 'original') }}">
                                                                </div>
                                                            </div>
